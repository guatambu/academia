...
extension AdultStudentFirestore: AdultStudentFirestoreModelSerializable {
    ...
    init?(dictionary: [String : Any]) {
        ...
        guard let isKid = dictionary["isKid"] as? Bool else {
            ...
            print("ERROR: nil value found for isKid in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 144.")
            return nil
        }
        
        guard let isInstructor = dictionary["isInstructor"] as? Bool else {
            
            print("ERROR: nil value found for isInstructor in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 150.")
            return nil
        }
        
        guard let academyChoice = dictionary["academyChoice"] as? String else {
            
            print("ERROR: nil value found for academyChoice in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 156.")
            return nil
        }
        
        guard let dateCreated = dictionary["dateCreated"] as? Timestamp else {
            
            print("ERROR: nil value found for dateCreated in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 162.")
            return nil
        }
        
        guard let dateEdited = dictionary["dateEdited"] as? Timestamp else {
            
            print("ERROR: nil value found for dateEdited in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 168.")
            return nil
        }
        
        guard let birthdate = dictionary["birthdate"] as? Timestamp else {
            
            print("ERROR: nil value found for birthdate in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 174.")
            return nil
        }
        
        guard let mostRecentPromotion = dictionary["mostRecentPromotion"] as? Timestamp else {
            
            print("ERROR: nil value found for mostRecentPromotion in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 180.")
            return nil
        }
        ...
        guard let firstName = dictionary["firstName"] as? String else {
            ...
            print("ERROR: nil value found for firstName in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 192.")
            return nil
        }
        
        guard let lastName = dictionary["lastName"] as? String else {
            
            print("ERROR: nil value found for lastName in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 198.")
            return nil
        }
        ...
        guard let phone = dictionary["phone"] as? String else {
            ...
            print("ERROR: nil value found for phone in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 234.")
            return nil
        }
        
        guard let mobile = dictionary["mobile"] as? String else {
            
            print("ERROR: nil value found for mobile in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 240.")
            return nil
        }
        
        guard let email = dictionary["email"] as? String else {
            
            print("ERROR: nil value found for email in firestore dictionary in AdultStudentFirestore.swift -> init(dictionary:) - line 246.")
            return nil
        }
