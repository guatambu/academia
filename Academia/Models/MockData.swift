...
//    // groups
//
//    static var kidsParents = /*Group(active: true, name: "kids Parents", dateCreated: Date(), dateEdited: Date(), members: [kidA, kidB, owner], paymentProgram: [kidsProgram], location: myLocation, aula: [kidsClassA])*/ [Group]()
//
//    static var adults = /*Group(active: true, name: "adults", dateCreated: Date(), dateEdited: Date(), members: [adultA, adultB, instructorA, instructorB, owner], paymentProgram: [adultsProgram], location: myLocation, aula: [adultClassA])*/ [Group]()
//
//    static var instructors = /*Group(active: true, name: "instructors", dateCreated: Date(), dateEdited: Date(), members: [owner, instructorB, instructorA], paymentProgram: [adultsProgram], location: myLocation, aula: [adultClassA])*/ [Group]()
//
//    static var allStudents = /*Group(active: true, name: "all students", dateCreated: Date(), dateEdited: Date(), members: [owner, instructorA, instructorB, adultA, adultB, kidA, kidB], paymentProgram: [adultsProgram, kidsProgram], location: myLocation, aula: [kidsClassA, adultClassA])*/[Group]()
//
//
//
//    // adult basic belts
