...
struct MockData {
    ...
    // classes
    static let adultClassA: Aula = Aula(aulaUID: UUID(), active: true, aulaName: "adult A", aulaDescription: "A class for the adults",  daysOfTheWeek: [ClassTimeComponents.Weekdays.Monday, ClassTimeComponents.Weekdays.Wednesday, ClassTimeComponents.Weekdays.Friday], timeOfDay: "\(ClassTimeComponents.Hours.eighteen.rawValue)", location: myLocation, students: [adultA], instructor: [adultA], currentDate: Date(), dateCreated: Date(), dateEdited: Date(), attendees: [adultA])
