...
class KidStudentModelController {
    ...
    var kidStudentOnboardingTasks: [OnBoardingTask] = [
        ...
        OnBoardingTask(name: "messagingGroups", title: "News From The Source", description: "Please have your teacher add you to your academy's message group(s).", isCompleted: false, dateCompleted: nil, dateOfMostRecentChange: nil),
